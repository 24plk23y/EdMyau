...
public class AutoRod extends Module {
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        AutoProjectiles autoProjectiles = ((AutoProjectiles) Myau.moduleManager.modules.get(AutoProjectiles.class));
    ...
    private boolean isValidTarget(EntityLivingBase entity, double distance) {
        ...
        if (TeamUtil.isSameTeam(player) || TeamUtil.isBot(player)) {
            return false;
        }
        return true;
    }
    ...
    private boolean isKillAuraEnabled() {
        Module killAura = Myau.moduleManager != null ? Myau.moduleManager.modules.get(KillAura.class) : null;
