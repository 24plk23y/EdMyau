...
public class KillAura extends Module {
    ...
    public final PercentProperty minSmoothing;
    public final IntProperty minAngleStep;
    public final PercentProperty maxSmoothing;
    public final IntProperty maxAngleStep;
    ...
    public KillAura() {
        ...
        this.minSmoothing = new PercentProperty("min-smoothing", 0);
        this.maxSmoothing = new PercentProperty("max-smoothing", 0);
        this.minAngleStep = new IntProperty("min-angle-step", 90, 10, 180);
        this.maxAngleStep = new IntProperty("max-angle-step", 90, 10, 180);
...
(float) (int) RandomUtil.nextLong(
        this.minAngleStep.getValue(),
        this.maxAngleStep.getValue()
) + RandomUtil.nextFloat(-5.0F, 5.0F),

(float) (int) RandomUtil.nextLong(
        this.minSmoothing.getValue(),
        this.maxSmoothing.getValue()
) / 100.0F
                        );
