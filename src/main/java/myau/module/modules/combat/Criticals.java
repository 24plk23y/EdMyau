...
public class Criticals extends Module {
    ...
    public final ModeProperty mode = new ModeProperty("mode", 0, new String[]{"Packet", "NCPPacket", "OldBlocksMC", "OldBlocksMC2", "NoGround", "Hop", "TPHop", "Jump", "LowJump", "CustomMotion", "Visual", "Legit"});
    ...
    public String[] getSuffix() {
        String[] modes = new String[]{"Packet", "NCPPacket", "OldBlocksMC", "OldBlocksMC2", "NoGround", "Hop", "TPHop", "Jump", "LowJump", "CustomMotion", "Visual", "Legit"};
