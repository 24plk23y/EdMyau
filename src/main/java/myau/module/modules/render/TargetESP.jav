...
import myau.util.MathUtil;
import myau.util.TeamUtil;
import myau.util.TimerUtil;
import myau.util.AnimationUtil;
import myau.util.ColorUtil;
import myau.util.ProjectionUtil;
...
import static myau.util.MathUtil.interpolate;
...
public class TargetESP extends Module {
    ...
    private final ResourceLocation glowCircle = new ResourceLocation("minecraft", "myau/targetesp/glow_circle.png");
    private final ResourceLocation rectangle = new ResourceLocation("minecraft", "myau/targetesp/rectangle.png");
    private final ResourceLocation quadstapple = new ResourceLocation("minecraft", "myau/targetesp/quadstapple.png");
    private final ResourceLocation trianglestapple = new ResourceLocation("minecraft", "myau/targetesp/trianglestapple.png");
    private final ResourceLocation trianglestipple = new ResourceLocation("minecraft", "myau/targetesp/trianglestipple.png");
    private final ResourceLocation aim = new ResourceLocation("minecraft", "myau/targetesp/shenmi.png");
    ...
    switch (colorMode.getValue()) {
        ...
        case 2:
            ...
            return ColorUtil.interpolate(
                    progress,
                    new Color(fadeColor1.getValue()),
                    new Color(fadeColor2.getValue())
            );
