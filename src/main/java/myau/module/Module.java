...
import myau.module.modules.EdNotification;
...
public abstract class Module {
    ...
    if (this.enabled != enabled) {
        ...
        EdNotification notification =
                (EdNotification) Myau.moduleManager.modules.get(EdNotification.class);

        if (notification != null) {
            notification.moduleToggle(this, enabled);
        }
