...
public class ClickGui extends GuiScreen {
    ...
    public ClickGui() {
        ...
        combatModules.add(Myau.moduleManager.getModule(AutoSoup.class));
        combatModules.add(Myau.moduleManager.getModule(AutoProjectiles.class));
        combatModules.add(Myau.moduleManager.getModule(AutoRod.class));
        ...
        combatModules.add(Myau.moduleManager.getModule(KillAura2.class));
        ...
        combatModules.add(Myau.moduleManager.getModule(AntiVelocity.class));
        ...
        movementModules.add(Myau.moduleManager.getModule(EntitySpeed.class));
        ...
        movementModules.add(Myau.moduleManager.getModule(NoSlow2.class));
        ...
        renderModules.add(Myau.moduleManager.getModule(EdNotification.class));
        ...
        renderModules.add(Myau.moduleManager.getModule(ItemRotate.class));
        ...
        renderModules.add(Myau.moduleManager.getModule(Health.class));
        ...
        playerModules.add(Myau.moduleManager.getModule(CrushAura.class));
        ...
        playerModules.add(Myau.moduleManager.getModule(Gapple.class));
        playerModules.add(Myau.moduleManager.getModule(Gapple2.class));
...
playerModules.add(Myau.moduleManager.getModule(MCF.class));
        ...
        miscModules.add(Myau.moduleManager.getModule(IQBoost.class));
    ...
    public void drawScreen(int x, int y, float p) {
        ...
        mc.fontRendererObj.drawStringWithShadow("dev: ksyz, 7S_TANZ, ChatGPT", 4, this.height - 3 - mc.fontRendererObj.FONT_HEIGHT, new Color(60, 162, 253).getRGB());
